...
import com.app.travel.models.additionaldata.TripRoutesData;
...
public class GenericCaster {
    ...
    public static AdditionalData castToAppropriateType(Map<String, Object> kvp) {
        ...
        var list = List.of((Function<Map<String, Object>, AdditionalData>) TripRoutesData::CastFromMap);
    ...
    public static AdditionalData castToAppropriateType(String json){
        ...
        var list = List.of((Function<String, AdditionalData>) TripRoutesData::CastFromString);
