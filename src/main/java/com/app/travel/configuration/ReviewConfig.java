...
public class ReviewConfig {
    ...
    CommandLineRunner commandLineRunnerReview (ReviewRepository reviewRepository){
        Booking booking = new Booking(1,"R8092", "Booking Num1", "First booking this year","Region 1", 1,1,10,2393,30, true, LocalDate.now(), LocalDate.of(2023,1,1), null,null, BookingStatus.UnderReview, "");
